...
<p>
{if $showabstract}
<a href="login.php?action=submissions&sortby={$sorting}&dir={$dir}&hideabstract">Hide abstracts</a>
{else}
<a href="login.php?action=submissions&sortby={$sorting}&dir={$dir}">Show abstracts</a>
{/if}
<br>
<a href="login.php?action=submissions&sortby={$sorting}&dir={$dir}&simple">Simple view</a>
</p>
...
<td class="titlelist">
<a href="login.php?action=showsubmission&id={$submission.id}">{$submission.title}</a>
</td>
</tr>
